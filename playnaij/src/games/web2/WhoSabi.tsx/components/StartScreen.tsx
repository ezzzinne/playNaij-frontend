    ...
    return (
      <>
        <div className="text-center d-flex flex-column justify-content-evenly align-items-center my-4 rounded-2" style={{ minHeight: '100vh', backgroundColor: '#4C1111'}}>
          ...
          <button className="btn w-25 px-4 w-lg-50 fs-6" onClick={handleStart} style={{ color: 'black', maxWidth:'350px', background: 'linear-gradient(180deg, #ECEBEB -32.81%, #10B981 56.44%, #ECEBEB 135.94%)'}}>Start <span className='ms-2'><img src={Play} /></span></button>
        </div>
